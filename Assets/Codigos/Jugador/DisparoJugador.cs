...
namespace CompleteProject
{
    ...
    {
        public int danoPorDisparo = 20;                  // The damage inflicted by each bullet.
        public float tiempoEntreDisparos = 0.15f;        // The time between each shot.
        public float rango = 100f;                      // The distance the gun can fire.
